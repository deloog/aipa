...
import Grid from '@mui/material/Grid'; // 虽然我们用Box替代了Grid item的布局，但如果之前有残留Grid container，或者未来可能用到，先保留。如果没有用到，最终可以移除。
                                      // 经过检查，我们用Box替换了Grid container和item，所以这个Grid导入可以移除。
...
const RequirementsReviewPage: React.FC = () => {
  ...
  // VV V V V  确保这些函数在 RequirementsReviewPage 组件内部 V V V V V
