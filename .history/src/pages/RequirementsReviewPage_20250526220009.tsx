    ...
    >
      ...
      >
        ...
        <Grid container spacing={3} sx={{ flexGrow: 1 }}> {/* 增加了spacing */}
          ...
          >
            <Paper elevation={0} variant="outlined" sx={{ width: '100%',flexGrow: 1, p: 1.5, overflowY: 'auto' }}> {/* 改为variant="outlined"更简洁 */}
          ...
          >
            <Paper elevation={0} variant="outlined" sx={{ width: '100%', height: '100%', p: {xs: 2, md: 3}, overflowY: 'auto' }}> {/* 改为variant="outlined"更简洁 */}
              {/* 9. 动态显示选定章节的内容 */}
              {selectedChapter ? (
                <>
        ...
        >
          ...
          <Button
            variant="outlined"
            color="warning" // 使用警告色提示这是一个可能中断当前流程的操作
            onClick={() => {
          ...
          <Button
            variant="contained" // 使用实心按钮作为主要操作
            color="primary"
            onClick={() => {
